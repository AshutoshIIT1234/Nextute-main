...
const StudentServicesPage = ({ onBack }) => {
  ...
  const studentPlans = [
    ...
    },
    {
      ...
      originalPrice: { monthly: 999, annual: 9999 },
      badge: "Most Popular",
      description: "Everything you need to succeed",
      trialDays: 7,
      plan_id: "plan_RINrwvIGY6EaJU", // Added the plan ID here
      features: [
        "All Basic Features",
        "Personalized recommendations",
        "Advanced search filters",
        "Detailed institute insights",
    ...
    },
    {
      ...
      originalPrice: { monthly: 2199, annual: 21999 },
      badge: null,
  ...
  const testimonials = [
    {
      id: "t1",
      text: "Nextute helped me find the perfect coaching institute. The comparison feature and student reviews were incredibly helpful!",
      quote: "The platform made my JEE preparation so much easier.",
      author: "Priya Sharma, JEE Aspirant",
      rating: 5,
    },
    {
      id: "t2",
      text: "The personalized test analytics feature helped me identify my weak areas and improve my performance dramatically.",
      quote: "Nextute's analytics boosted my NEET score significantly.",
      author: "Anita Patel, NEET Aspirant",
      rating: 4.5,
    },
    {
      id: "t3",
      text: "The AI-powered study planner kept me on track throughout my preparation. I couldn't have done it without Nextute!",
      quote: "The study planner was a game-changer for me.",
      author: "Rahul Verma, JEE Aspirant",
      rating: 5,
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F9FBF9] to-[#E6EEE3]">
      ...
      <section className="py-20 text-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            Tailored pricing for students seeking academic excellence
          </p>
          <div
